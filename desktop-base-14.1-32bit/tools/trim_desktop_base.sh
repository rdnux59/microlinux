...
# Desktop Base. It removes unneeded packages and installs needed ones. You might run
...
echo
echo ":: System is ready for building the Microlinux Enterprise Desktop Base."
echo
