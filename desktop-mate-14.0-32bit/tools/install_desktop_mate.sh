...
# -----------------------------------------------------------------------------
#
# This script parses the packages-desktop-mate file in the pkglists directory and
...
INSTALL=$(egrep -v '(^\#)|(^\s+$)' $CWD/pkglists/packages-desktop-mate)
...
echo
echo ":: Microlinux Enterprise Desktop MATE installed."
echo
