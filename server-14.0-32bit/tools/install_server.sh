...
# -----------------------------------------------------------------------------
#
# This script parses the packages-server file in the pkglists directory and
...
INSTALL=$(egrep -v '(^\#)|(^\s+$)' $CWD/pkglists/packages-server)
...
echo
echo ":: Extra Software for Slackware Server installed."
echo
